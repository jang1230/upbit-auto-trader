...
주문 식별자 없이 특정 페어의 전체 주문 내역을 조회하고자 하시는 경우, 또는 시간을 조회 기준으로 적용해야 하는 경우 [체결 대기 주문 목록 조회](ref:list-open-orders) 또는 [종료 주문 목록 조회](ref:list-closed-orders) API를 사용할 수 있습니다.
